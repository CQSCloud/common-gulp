module.exports = {
  ...
  'jslint-clientSpec': require('./tasks/jslint-client-spec'),
  'jslint-database': require('./tasks/jslint-database'),
  'jslint-server': require('./tasks/jslint-server'),
  'jslint-serverSpec': require('./tasks/jslint-server-spec'),
  'jslint-shared': require('./tasks/jslint-shared'),
  'jslint-sharedSpec': require('./tasks/jslint-shared-spec'),
